...
import CheckboxSelectionWithSelectAll from "./Component/CheckboxSelectionWithSelectAll";
import RowCollapseExpand from "./Component/CollapseExpand";
import LineClampWithSeeMore from "./Component/LineClampWithSeeMore";
...
const App = () => {
  ...
  const data1 = [
    { id: "1", message: "This is message number 1", notification: "number 1" },
    { id: "2", message: "This is message number 2", notification: "number 2" },
    { id: "3", message: "This is message number 3", notification: "number 3" },
    { id: "4", message: "This is message number 4", notification: "number 4" },
    { id: "5", message: "This is message number 5", notification: "number 5" },
    { id: "6", message: "This is message number 5", notification: "number 5" },
    { id: "7", message: "This is message number 5", notification: "number 5" },
    { id: "9", message: "Another message number 6", notification: "number 6" },
    { id: "10", message: "Yet another message number 7", notification: "number 7" },
  ];

  const messages = [
    "Lorem ipsum dolor sit nisl placerat augue.",
    "This is a sample message for testing. It demonstrates how to handle clamping of multiple lines with 'see more' functionality.",
    "React is a powerful library for building dynamic user interfaces. This component demonstrates dynamic clamping of text with ellipsis."
  ];
  ...
  return (
    ...
    <CheckboxSelectionWithSelectAll></CheckboxSelectionWithSelectAll>
        <RowCollapseExpand/>

        <div>
        <NotificationCard data={data1} />    
        </div>
    </div>
  );
};
